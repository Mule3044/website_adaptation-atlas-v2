    ...
    <div id='related-posts' className='max-w-[940px] mx-auto mt-20 mb-20'>
      ...
      <div>
        {posts.map((post: RelatedPost) => {
          ...
          return (
            <Link href={url} className='relative flex justify-between items-center bg-grey-100 pl-6 pr-8 py-4 mb-4 w-full transition-colors hover:bg-brand-green hover:text-white group'>
              <Image // icon
                src={type!.image}
                alt={'Icon'}
                width={18}
                ...
                className='absolute'
              />
              <p className='ml-8 mr-8 mb-0 text-[20px] truncate'>{post.title}</p>
