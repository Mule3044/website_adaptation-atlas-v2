...
const SearchModal = ({modalState}: any) => {
    ...
    return (
      ...
      >
        ...
        <div className={`h-screen w-screen fixed ${open && isDesktop ? ' bg-white/95 top-0 left-0' : ''}  ${open && !isDesktop ? ' bg-white top-[-245px] left-0' : ''} z-80 ${open && 'transition ease-in-out delay-150 duration-300'}`}>
